...
const RRUpload = ({RRUploadForm,setRRUploadForm}) => {
  ...
  return (
    <Modal
        ...
        visible={RRUploadForm}
        onCancel={() => setRRUploadForm(false)}
        footer={false}
        width={1000}
      >
        ...
        <div className="d-flex justify-content-end mt-5">
          <Button key="cancel" onClick={() => setRRUploadForm(false)}>
            Cancel
          </Button>
          <Button
            key="save"
